...
data class IncidentResponseDto(
  ...
  companion object {
    ...
    const val INCIDENT_RESPONSE_QUESTION_SERIOUS_INJURY = "WAS A SERIOUS INJURY SUSTAINED"
    const val INCIDENT_RESPONSE_QUESTION_RESULT_IN_HOSPITAL = "DID INJURIES RESULT IN DETENTION IN OUTSIDE HOSPITAL AS AN IN-PATIENT"
